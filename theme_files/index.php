<?php get_header(); ?>
    ...
    <main class="site-content index">
        ...
        <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
            <section class="home-posts" style="background-image: url(<?php echo get_the_post_thumbnail_url(); ?>)">
                <article <?php post_class(); ?>>
                    ...
                    <div class="index-main-excerpt-container absolute bottom-0 width-70 padding-left-4-5pc padding-right-6pc dark">
                        <div class="roboto font-size-0-8 font-weight-300 text-uppercase letter-spacing-0-1 line-height-1-1"><?php echo do_shortcode(get_the_excerpt()); ?></div>
                    </div>
                </article>
            </section>
