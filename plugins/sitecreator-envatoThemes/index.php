...
// function envatothemes_button_action()
// {
//   echo '<div id="message" class="updated fade"><p>'
//     .'The "Call Function" button was clicked.' . '</p></div>';

//   //$path = WP_TEMP_DIR . '/envatothemes-button-log.txt';

//   //$handle = fopen($path,"w");

//   if ($handle == false) {
//     echo '<p>Nuffin done nigga!</p>';
//   }
//   else {
//     echo '<p>Themes Added.</p>';
...
// function sitecreator_check_transient() {
//   if(($envato_themes = get_transient("get_envato_transient")) === false) 
//     { 
//       $envato_themes = sitecreator_get_envato_themes();
//       set_transient("get_envato_transient", 'get_envato_themes', 10);
//       //return $envato_themes;
//     }
// }
// add_action('plugins_loaded' , 'sitecreator_check_transient')  ;

function sitecreator_get_envato_themes() {
